...
1. Data problems with the albums endpoint:
   ...
   - No support for filters, the filtering has to be done locally. This can cause bad UX, like the filters increasing in size as the user paginates (older records add older years to the filter).
